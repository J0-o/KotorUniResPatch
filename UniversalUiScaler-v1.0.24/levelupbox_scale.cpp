...
void scaleLevelUpBoxPanel(void* ownerPtr, DWORD expectedVtable) {
...
void scaleQuickOrCustomPanel(void* owner) {
    scaleLevelUpBoxPanel(owner, QuickOrCustomVtable);
}

void scaleQuickPanel(void* owner) {
    scaleLevelUpBoxPanel(owner, QuickPanelVtable);
}

void scaleLevelUpPanel(void* owner) {
    scaleLevelUpBoxPanel(owner, LevelUpPanelVtable);
}

void scaleCustomPanel(void* owner) {
    scaleLevelUpBoxPanel(owner, CustomPanelVtable);
}
